    ...
    public partial class alma : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CardModelId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TagsGuid = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardModelTag", x => new { x.CardModelId, x.TagsGuid });
                    table.ForeignKey(
                        name: "FK_CardModelTag_CardModel_CardModelId",
                        column: x => x.CardModelId,
                        principalTable: "CardModel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CardModelTag_Tag_TagsGuid",
                        column: x => x.TagsGuid,
                        principalTable: "Tag",
